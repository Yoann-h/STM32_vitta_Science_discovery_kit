...
C_SRCS += \
../modules/analogic/analog_mng.c 

OBJS += \
./modules/analogic/analog_mng.o 

C_DEPS += \
./modules/analogic/analog_mng.d 


# Each subdirectory must supply rules for building sources it contributes
modules/analogic/%.o modules/analogic/%.su modules/analogic/%.cyclo: ../modules/analogic/%.c modules/analogic/subdir.mk
...
clean: clean-modules-2f-analogic

clean-modules-2f-analogic:
	-$(RM) ./modules/analogic/analog_mng.cyclo ./modules/analogic/analog_mng.d ./modules/analogic/analog_mng.o ./modules/analogic/analog_mng.su

.PHONY: clean-modules-2f-analogic

...
C_SRCS += \
../modules/command/cli.c 

OBJS += \
./modules/command/cli.o 

C_DEPS += \
./modules/command/cli.d 


# Each subdirectory must supply rules for building sources it contributes
modules/command/%.o modules/command/%.su modules/command/%.cyclo: ../modules/command/%.c modules/command/subdir.mk
...
clean: clean-modules-2f-command

clean-modules-2f-command:
	-$(RM) ./modules/command/cli.cyclo ./modules/command/cli.d ./modules/command/cli.o ./modules/command/cli.su

.PHONY: clean-modules-2f-command

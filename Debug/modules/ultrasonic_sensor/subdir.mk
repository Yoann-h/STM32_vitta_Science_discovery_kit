...
C_SRCS += \
../modules/ultrasonic_sensor/grove_HCSR04.c 

OBJS += \
./modules/ultrasonic_sensor/grove_HCSR04.o 

C_DEPS += \
./modules/ultrasonic_sensor/grove_HCSR04.d 


# Each subdirectory must supply rules for building sources it contributes
modules/ultrasonic_sensor/%.o modules/ultrasonic_sensor/%.su modules/ultrasonic_sensor/%.cyclo: ../modules/ultrasonic_sensor/%.c modules/ultrasonic_sensor/subdir.mk
...
clean: clean-modules-2f-ultrasonic_sensor

clean-modules-2f-ultrasonic_sensor:
	-$(RM) ./modules/ultrasonic_sensor/grove_HCSR04.cyclo ./modules/ultrasonic_sensor/grove_HCSR04.d ./modules/ultrasonic_sensor/grove_HCSR04.o ./modules/ultrasonic_sensor/grove_HCSR04.su

.PHONY: clean-modules-2f-ultrasonic_sensor
